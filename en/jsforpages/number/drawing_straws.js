function drawing_straws() {
    ...
    if ( (choose_num%1) != 0 || choose_num <= 0) {
        document.getElementById("drawing_list").value += "Please enter the correct number";
      }
    else {
      ...
      if (choose_num > array_items.length) {
        document.getElementById("drawing_list").value += "Please enter the numbers within the range.";
      }
